...
/**
 * Used to define tiles to be drawn to screen.
 */
shared.Tile = class Tile extends this.shared.MapDataObject {
    x 
    y 
    lengthX
    lengthY
    ...
    constructor(x, y, lengthX, lengthY, zoomLevel) {
        super();
        this.x = x 
        this.y = y 
    ...
    get fileName() {
        return `${this.x}x${this.y}_${this.zoomLevel}x.png`;
    }

    static tileFromObject(object) {
        let tile = new shared.Tile(object.x, object.y, object.lengthX, object.lengthY, object.zoomLevel);
        tile.ID = object.ID;
